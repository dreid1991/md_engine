#pragma once
#ifndef FIXE3B_GMX_TWOBODY_H
#define FIXE3B_GMX_TWOBODY_H
...
class FixE3B_GMX_twobody: public Fix {
    private: 
    ...
    public:
         ...
         */
        FixE3B_GMX_twobody(boost::shared_ptr<State> state,
                  std::string handle,
                  std::string style);
