...
ACCUMULATION_CLASS_IF(SumVirialIf, Virial, Virial, vir, vir, Virial(0, 0, 0, 0, 0, 0));
...
ACCUMULATION_CLASS_IF(SumVectorToVirialOverWIf, Virial, float4, v, Virial(v.x*v.x/v.w, v.y*v.y/v.w, v.z*v.z/v.w, v.x*v.y/v.w, v.x*v.z/v.w, v.y*v.z/v.w), Virial(0, 0, 0, 0, 0, 0)); 
ACCUMULATION_CLASS_IF(SumVirialToScalarIf, float, Virial, vir, (vir[0]+vir[1]+vir[2]), 0); 
