...
positions,velocities,forces,box=read_gromacs_trajectory("../tip4p_2005_speed/tip4p_init_1000.out",1,True,False,False,True)
...
# write every 10 fs
#print '\nnow doing NVE run!\n'
writer = WriteConfig(state, handle='writer', fn='e3b3_nve', format='xyz',
                     writeEvery=10)
