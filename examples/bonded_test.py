...
sys.path = sys.path + ['../core/build/python/build/lib.linux-x86_64-2.7', '../core/build/']
from Sim import *
from math import *
state = State()
...
dihedralOPLS.setDihedralTypeCoefs(type=0, coefs=[-1, 0, 0, 0])
...
fixNVT = FixNVTRescale(state, 'temp', 'all', [0, 1], [.02, .02], 10)
