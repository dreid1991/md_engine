...
reader = LAMMPS_Reader(state=state, unitLen = unitLen, unitMass = 12, unitEng = 0.066, bondFix = bondHarm, nonbondFix = ljcut,  angleFix = angleHarm,improperFix=improperHarm, dihedralFix = dihedralOPLS,atomTypePrefix = 'PTB7_', setBounds=False)
