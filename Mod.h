...
namespace Mod {
    ...
    */
	...
	__global__ void unskewAtoms(cudaSurfaceObject_t xs, int nAtoms, float3 xOrig, float3 yOrig, float3 lo);
	__global__ void skewAtomsFromZero(cudaSurfaceObject_t xs, int nAtoms, float3 xFinal, float3 yFinal, float3 lo);
