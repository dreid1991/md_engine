...
class FixLJCut : public FixPair {
    public:
        ...
        GPUArrayGlobal<float> epsilons; //!< Array of epsilon values
        GPUArrayGlobal<float> sigmas; //!< Array of sigma values
        GPUArrayGlobal<float> rCuts; //!< Array of type-specific cutoff values
